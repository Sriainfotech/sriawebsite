...
const FieldServiceMgmt = () => {
 ...
 <SolutionPageLayout
      ...
      subtitle="Optimize field service execution with AI-driven scheduling, dispatching, and real-time Salesforce integration."
      breadcrumbs={[{ name: "Solutions" }, { name: "SAP HXM" }, { name: "Field Service", path: "/solutions/field-service-management" }]}
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Solutions/service-hero.jpg?tr=f-auto,q-auto,w-1600"
