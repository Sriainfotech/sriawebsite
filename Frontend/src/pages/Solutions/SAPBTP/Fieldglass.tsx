...
const Fieldglass = () => {
 ...
 <SolutionPageLayout
      ...
      subtitle="Manage contingent labor with full visibility into budgets, milestones, and workforce engagement."
      breadcrumbs={[{ name: "Solutions" }, { name: "SAP BTP" }, { name: "Fieldglass", path: "/solutions/fieldglass" }]}
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Solutions/field-hero.jpg?tr=f-auto,q-auto,w-1600"
