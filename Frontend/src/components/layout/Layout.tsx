...
const Layout = () => {
 ...
 <FloatingButtons />
 {/*
 Stacked above the chat button (ChatWidget.tsx: bottom-24/28,
 w-12/14 h-12/14) with a ~16px gap, same right offset, so the two
 never overlap.
 */}
 <a
 ...
 className="fixed right-4 sm:right-6 bottom-[160px] sm:bottom-[184px] z-[9999] bg-green-600 text-white rounded-full w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center shadow-lg hover:scale-110 hover:shadow-2xl transition-all"
 >
