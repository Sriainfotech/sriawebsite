...
const Digital = () => {
 ...
 <SolutionPageLayout
      ...
      subtitle="Digitize shop-floor processes with paperless work instructions, traceability, and IIoT integration."
      breadcrumbs={[{ name: "Solutions" }, { name: "SAP CRM" }, { name: "Digital Manufacturing", path: "/solutions/digital-manufacturing" }]}
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Solutions/digital-hero.jpg?tr=f-auto,q-auto,w-1600"
