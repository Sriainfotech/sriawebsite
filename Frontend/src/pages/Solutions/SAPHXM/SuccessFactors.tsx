...
const SuccessFactors = () => {
 ...
 <SolutionPageLayout
      ...
      breadcrumbs={[{ name: "Solutions" }, { name: "SAP HXM" }, { name: "SuccessFactors", path: "/solutions/successfactors" }]}
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Solutions/success-hero.jpg?tr=f-auto,q-auto,w-1600"
