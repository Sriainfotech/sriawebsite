...
const leaders = [
    ...
    },
    {
        ...
        image: "https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779454671/sria/sai.png",
    ...
    //     image: "https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779454671/sria/cofounder2.jpg",
                            ...
                            <div key={i} className="min-w-0 flex-[0_0_100%]">
                                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 px-1">
                                    ...
                                    <div className="flex-1 pt-4 lg:pt-0">
                                        ...
                                        <h3 className="text-xl md:text-2xl lg:text-3xl font-heading font-bold text-white leading-tight mb-6">
                                            {leader.quote}
                                        </h3>
                                        ...
                                        {/* Gradient divider */}
                                        <div className="h-px bg-gradient-to-r from-orange-500/60 to-transparent mb-8" />

                                        {/* Attribution */}
                                        <div>
                                            <p className="font-bold text-lg text-white">{leader.name}</p>
