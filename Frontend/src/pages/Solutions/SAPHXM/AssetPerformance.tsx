...
const faqs = [
    {
        question: "What is SAP Asset Performance Management (APM)?",
        answer:
            "SAP APM is a cloud-based solution that helps organizations optimize asset health, predict failures, and improve maintenance strategies using real-time data and AI.",
    },
    {
        question: "How does SAP APM improve reliability?",
        answer:
            "It uses predictive analytics, risk assessments, and reliability-centered maintenance (RCM) methodologies to identify potential issues before they cause downtime.",
    },
    {
        question: "Does it integrate with SAP S/4HANA?",
        answer:
            "Yes, SAP APM integrates seamlessly with SAP S/4HANA Asset Management and SAP Enterprise Asset Management (EAM) for end-to-end maintenance workflows.",
    },
    {
        question: "Can SAP APM connect to IoT sensors?",
        answer:
            "Absolutely. It supports connectivity with IoT platforms and historians to ingest real-time sensor data for condition monitoring.",
    },
    {
        question: "What is 'Asset Strategy' in APM?",
        answer:
            "Asset Strategy involves defining the optimal maintenance approach (preventive, predictive, corrective) based on asset criticality and risk analysis.",
    },
];
...
const sampleSolutions = [
    {
        title: "Strategy",
        heading: "APM Strategy & Roadmap",
        description:
            "Plan your reliability journey.",
        points: [
            "Maturity assessment",
            "Goal & KPI definition",
            "Phased rollout plan",
    ...
    {
        title: "Data",
        heading: "Data Preparation & Governance",
        description:
            "Ensure data quality.",
        points: [
...
const sapData = {
    ...
    description:
        "Your Trusted Partner in SAP Transformation. We help organizations optimize asset reliability and performance for sustainable growth.",
    imageUrl: "/Solutions/successfactors.png",
    imageAlt: "SAP Asset Performance Management",
    items: [
        {
            title: "APM Strategy",
            highlight: "Roadmap Design",
            description:
                "Assess maturity and define a clear path to intelligent asset management.",
        },
        {
            title: "Implementation",
            highlight: "Core APM",
            description:
                "Deploy predictive maintenance, risk analysis, and reliability strategies.",
        },
        {
            title: "Analytics",
            highlight: "AI Insights",
            description:
                "Leverage machine learning to predict failures and optimize maintenance schedules.",
        },
    ],
};
...
function AssetPerformance() {
    return (
        <div className="min-h-screen">
            ...
            <PageHeader
                title="SAP Asset Performance Management"
                ...
                breadcrumbs={[
                    ...
                    { name: "Asset Performance", path: "/solutions/asset-performance" },
                ]}
                    ...
                    <section id="features" className="mt-12 sm:mt-16 scroll-mt-24">
                        <div className="flex justify-center">
                            {/* <ConsultationTabsSection
                                ...
                                mainDescription="Our services cover the entire APM lifecycle from strategy and implementation to predictive analytics and support."
                            // ctaText="Get a Consultation"
                            /> */}
                            <div className="w-full">
                                <h2 className="text-3xl font-bold mb-4">Delivering Impact-Driven SAP Implementations for Sustainable Growth</h2>
                                <p className="mb-8 text-gray-600">Our services cover the entire APM lifecycle from strategy and implementation to predictive analytics and support.</p>
