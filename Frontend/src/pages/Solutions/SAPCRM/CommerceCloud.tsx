...
const CommerceCloud = () => {
 ...
 <SolutionPageLayout
      ...
      breadcrumbs={[{ name: "Solutions" }, { name: "SAP CRM" }, { name: "Commerce Cloud", path: "/solutions/commerce-cloud" }]}
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Solutions/commerce-hero.jpg?tr=f-auto,q-auto,w-1600"
