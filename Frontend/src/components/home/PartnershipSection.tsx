...
import { Handshake, Building2, Users, Globe2 } from "lucide-react";
...
const PartnershipSection = () => {
 ...
 <h2 className="text-2xl md:text-3xl font-heading font-bold mt-2 mb-4">Trusted by Industry Leaders</h2>
