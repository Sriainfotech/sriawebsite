...
// "Show their favicon" — the sites' own /favicon.ico files are real but
...
const OUR_COMPANIES: Array<{
...
}> = [
  {
    ...
    icon: "https://ik.imagekit.io/hps6th7vy/sria/logos/nxgen_logo.png?tr=f-auto,q-auto,w-96",
  },
  {
    name: "NxSys Digital",
    url: "https://nxsysdigital.com",
    icon: "/nxsys_digital_icon.png",
  },
  {
    name: "SRIA Infotech",
  ...
  return (
    <div className="relative mx-auto flex min-h-screen w-full max-w-xl flex-col">
      ...
      <div className="relative flex flex-1 flex-col overflow-hidden bg-white shadow-sm sm:rounded-3xl sm:border sm:border-orange-100">
        ...
        {/* Our Companies */}
        <section className="px-4 pb-6 pt-0 sm:px-6">
