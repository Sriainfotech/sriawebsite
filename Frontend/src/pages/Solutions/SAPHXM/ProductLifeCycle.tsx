...
const faqs = [
    {
        question: "What is SAP PLM?",
        answer:
            "SAP Product Lifecycle Management (PLM) helps organizations manage the entire lifecycle of a product from ideation and design to manufacturing and service.",
    },
    {
        question: "Does SAP PLM integrate with CAD tools?",
        answer:
            "Yes, SAP PLM integrates with major CAD software (like AutoCAD, SolidWorks, CATIA) via the SAP Engineering Control Center (ECTR).",
    },
    {
        question: "What is BOM Management in SAP PLM?",
        answer:
            "It involves managing different types of Bills of Materials (eBOM, mBOM, sBOM) and ensuring synchronization between engineering and manufacturing.",
    },
    {
        question: "Can SAP PLM help with compliance?",
        answer:
            "Absolutely. It tracks regulatory compliance (REACH, RoHS, FDA) throughout the product lifecycle to ensure safety and marketability.",
    },
    {
        question: "What is Engineering Change Management?",
        answer:
            "It is a controlled process for handling changes to product designs and data, ensuring all stakeholders are aligned and impacts are analyzed.",
    },
];
...
const features = [
    ...
    },
    {
        ...
        image: "/Solutions/mobile-experience.png",
    },
];
...
const sampleSolutions = [
    ...
    },
    {
        ...
        description:
            "Core PLM setup and connections.",
        points: [
            "Part & Document Mgmt",
            "BOM Management",
            "CAD Integration (ECTR)",
            "ERP/MES Integration",
        ],
    },
    {
        ...
        description:
            "Seamless CAD and data exchange.",
        points: [
            "SAP ECTR deployment",
    ...
    },
    {
        ...
        description:
            "Harmonize engineering and manufacturing.",
        points: [
...
const sapData = {
    ...
    description:
        "Your Trusted Partner in SAP Transformation. We help organizations optimize their product lifecycle management for greater innovation, collaboration, and efficiency.",
    imageUrl: "/Solutions/successfactors.png",
    imageAlt: "SAP PLM",
    items: [
        {
            title: "PLM Strategy",
            highlight: "Roadmap Design",
            description:
                "Assess current processes and define a clear strategy for digital product transformation.",
        },
        {
            title: "Implementation",
            highlight: "Core PLM",
            description:
                "Deploy robust solutions for document management, BOMs, and engineering change control.",
        },
        {
            title: "Collaboration",
            highlight: "CAD Integration",
            description:
                "Enable seamless collaboration between engineering and manufacturing with SAP ECTR.",
        },
    ],
};
    ...
    return (
        <div className="min-h-screen">
            ...
            <PageHeader
                ...
                subtitle="Streamline product development, improve collaboration, and accelerate time-to-market with comprehensive lifecycle management."
                breadcrumbs={[
                    { name: "Solutions", path: "/solutions" },
                    { name: "SAP HXM", path: "/solutions/sap-hxm" },
                    { name: "Product Lifecycle Management", path: "/solutions/product-lifecycle-management" },
                ]}
                    ...
                    <section id="features" className="mt-12 sm:mt-16 scroll-mt-24">
                        <div className="flex justify-center">
                            {/* <ConsultationTabsSection
                                ...
                                mainDescription="Our services cover the entire product lifecycle from strategy and implementation to engineering collaboration and support."
                            // ctaText="Get a Consultation"
                            /> */}
                            <div className="w-full">
                                <h2 className="text-3xl font-bold mb-4">Delivering Impact-Driven SAP Implementations for Sustainable Growth</h2>
                                <p className="mb-8 text-gray-600">Our services cover the entire product lifecycle from strategy and implementation to engineering collaboration and support.</p>
