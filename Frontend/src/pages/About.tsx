          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-primary shadow-lg rounded-lg p-6 text-primary-foreground"
              >
                <div className="flex items-center gap-8">
                  <div className="text-center">
                    <p className="text-3xl font-heading font-bold">10+</p>
                    <p className="text-xs opacity-80 uppercase">Years</p>
                  </div>
                  <div className="w-px h-10 bg-primary-foreground/30" />
                  <div className="text-center">
                    <p className="text-3xl font-heading font-bold">100+</p>
                    <p className="text-xs opacity-80 uppercase">Clients</p>
                  </div>
                  <div className="w-px h-10 bg-primary-foreground/30" />
                  <div className="text-center">
                    <p className="text-3xl font-heading font-bold">3</p>
                    <p className="text-xs opacity-80 uppercase">Offices</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-card p-10 md:p-12 rounded-xl border border-border shadow-md"
            >
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="w-20 h-20 mx-auto mb-6 bg-primary/10 rounded-xl flex items-center justify-center group-hover:bg-primary transition-colors">
