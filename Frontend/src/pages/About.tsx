...
const offices = [
  ...
  { id: 2, country: "India", flag: "🇮🇳", name: "Hyderabad Office", address: "Third Floor, Udaya Vensar Apartments, Rd Number 1, Hanuman Nagar, Kothaguda, Kondapur, Hyderabad, Telangana 500084", phone: "+91 97013 14138", email: "hr@sriainfotech.com", image: "https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779454963/sria/hyderabad.png", mapDot: { top: "52%", left: "68%" }, tooltip: "Hyderabad, India" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageHeader
        ...
        backgroundImage="https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779454626/sria/aboutus.jpg"
      />
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full overflow-hidden ring-2 ring-orange-500/40 flex-shrink-0">
                  <img src="https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779455136/sria/sai.png" alt="Sai Kumar" className="w-full h-full object-cover object-top" />
                </div>
                <div>
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-80">
                <img
                  src="https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779455136/sria/sai.png"
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-10 items-start">
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-80">
                <img
                  src="https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779454982/sria/mission.jpg"
                  alt="Mission"
