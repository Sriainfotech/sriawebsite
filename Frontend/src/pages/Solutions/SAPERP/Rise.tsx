...
const advisoryServices = [
  {
    ...
    items: ["Readiness checks", "Current landscape analysis"],
  },
  {
    title: "Financial Evaluation",
    icon: <TrendingUp className="w-8 h-8 text-orange-600" />,
    items: ["Total cost of ownership (TCO)", "ROI forecasting"],
  },
  {
    title: "Cloud Strategy",
    icon: <Cloud className="w-8 h-8 text-orange-600" />,
    items: ["Cloud vs On-premise decision", "Architecture consulting"],
  },
];

const planningSteps = [
  {
    title: "Business Transformation Planning",
    desc: "Defining the strategic vision and roadmap.",
  },
  {
    title: "Migration Strategy",
    desc: "Crafting the optimal path for cloud architecture design.",
  },
  {
    title: "Value-Driven Roadmaps",
    desc: "Ensuring every step delivers measurable business value.",
  },
];
...
const integrationServices = [
  {
    ...
    icon: (
      <Layers className="w-12 h-12 mx-auto text-slate-400 group-hover:text-orange-600 mb-6 transition-colors" />
    ),
    desc: "Integration with third-party systems via SAP Integration Suite for a unified landscape.",
  },
  {
    title: "Custom Extensions via SAP BTP",
    icon: (
      <Code2 className="w-12 h-12 mx-auto text-slate-400 group-hover:text-orange-600 mb-6 transition-colors" />
    ),
    desc: "Extend core capabilities while keeping the digital core clean.",
  },
];
...
const Rise = () => {
  return (
    <div className="bg-white font-sans text-slate-800">
      ...
      {/* SECTION 1: Impact-Driven SAP Implementations */}
      ...
      {/* SECTION 2: Advisory & Assessment Services */}
      ...
      {/* SECTION 3: RISE with SAP Planning & Roadmapping */}
      <section className="py-20 px-6 lg:px-12 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          <div className="mb-16 text-center">
            <h2 className="text-3xl font-bold text-slate-900">
              RISE with SAP Planning & Roadmapping
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/3 sticky top-24 self-start">
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              Seamlessly deploy SAP S/4HANA Cloud with our expert-led
              methodologies, ensuring data integrity and process optimization.
            </p>
          </div>
      ...
      {/* SECTION 6: Change Management & Training */}
      ...
      {/* SECTION 7: Support & Optimization */}
      <section className="py-20 px-6 lg:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
      ...
      {/* SECTION 8: RISE Migration Factory */}
      <section className="py-20 px-6 lg:px-12 bg-slate-50">
          ...
          <div className="bg-white border-l-4 border-orange-600 rounded-r-lg shadow-lg p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="md:w-2/3">
              ...
              <p className="text-slate-600 text-lg mb-6">
                Factory model for mass migration (suitable for large clients or
      ...
      {/* SECTION 9: Your Trusted Partner in SAP Transformation */}
      <section className="py-20 px-6 lg:px-12 bg-white">
      ...
      {/* SECTION 10: End-to-End SAP Services */}
      <section className="py-20 px-6 lg:px-12 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 mb-12 text-center">
      ...
      {/* SECTION 11: Drive Innovation and Excellence with Latest Tech Trends */}
