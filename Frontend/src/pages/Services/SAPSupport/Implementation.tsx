...
const relatedServices = [
  ...
  { title: "Application Development", desc: "BTP cloud-native app development.", icon: <Layers className="w-8 h-8 text-orange-500" />, link: "/services/sap-application-development" },
...
function Implementation() {
  return (
    <ServicePageLayout
      ...
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Services/implement-hero.jpg?tr=f-auto,q-auto,w-2000"
