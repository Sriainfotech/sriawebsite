...
const categories = [
  {
    ...
    count: "5 solutions",
    items: [
      { num: "01", title: "SAP Financial Management", tagline: "Real-time, automated, insightful financial operations.", link: "/solutions/financial" },
      ...
      { num: "04", title: "SAP CPI",                   tagline: "Integrated, predictive, intelligent connectivity.",     link: "/solutions/cpi" },
