  ...
  return (
    <div className="w-full min-h-screen bg-white">
      <PageHeader
        ...
        backgroundImage="https://res.cloudinary.com/dmxfdt7ub/image/upload/f_auto,q_auto/v1779455097/sria/partners/sap-partner.png"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[400px]">
                <img
                  src="https://res.cloudinary.com/dmxfdt7ub/image/upload/f_auto,q_auto/v1779455092/sria/partners/partner-overview.png"
