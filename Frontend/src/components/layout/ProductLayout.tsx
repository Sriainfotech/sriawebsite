...
const ProductLayout: React.FC<ProductLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <Reveal x={20} y={0} duration={0.8} className="relative hidden lg:block">
              {overview.image ? (
                <>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-20">
            {featureDeepDive.sections.map((section, idx) => (
              ...
              >
                <Reveal x={section.reverse ? 40 : -40} y={0} duration={0.7} className="flex-1">
                ...
                <Reveal y={0} scale={0.97} duration={0.7} className="flex-1 w-full relative">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="bg-slate-950 rounded-2xl p-14 md:p-20 text-center relative overflow-hidden">
            <div
              className="absolute inset-0 opacity-[0.025] pointer-events-none"
              style={{ backgroundImage: `radial-gradient(circle, rgba(255,255,255,0.8) 1px, transparent 1px)`, backgroundSize: "32px 32px" }}
            />
