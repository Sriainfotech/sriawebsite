          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="bg-slate-50 rounded-2xl border border-slate-100 p-8 mb-8 inline-flex flex-col items-center w-full max-w-xs">
                <img src="https://res.cloudinary.com/dmxfdt7ub/image/upload/f_auto,q_auto/v1779455089/sria/partners/ivc-logo.png" alt="IVC Solutions" className="h-20 object-contain mb-4" />
