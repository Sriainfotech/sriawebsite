...
const relatedServices = [
  ...
  { title: "Development", desc: "Custom RICEFW development and Fiori apps.", icon: <Code className="w-8 h-8 text-orange-500" />, link: "/services/sap-application-development" },
...
function Abap() {
  return (
    <ServicePageLayout
      ...
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Services/abap.png?tr=f-auto,q-auto,w-1600"
