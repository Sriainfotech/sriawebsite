...
const leaders = [
  {
    ...
    image: "https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779454671/sria/chairman.jpg",
  ...
  },
  {
    ...
    image: "https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779455136/sria/sai.png",
  ...
  },
  {
    ...
    image: "https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779455115/sria/ravi.png",
  ...
  },
  {
    ...
    image: "https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779455326/sria/vinod.jpg",
  ...
  return (
    <div className="w-full min-h-screen bg-white">
      <PageHeader
        ...
        backgroundImage="https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779454975/sria/leadership.jpg"
      />
            ...
            >
              ...
              <div className="flex items-center gap-4 border-t border-white/10 pt-6">
                <div className="w-12 h-12 rounded-full overflow-hidden ring-2 ring-orange-500/40 flex-shrink-0">
                  <img src="https://res.cloudinary.com/dmxfdt7ub/image/upload/v1779454671/sria/chairman.jpg" alt="Ashwini Ganji" className="w-full h-full object-cover object-top" />
                </div>
                <div>
