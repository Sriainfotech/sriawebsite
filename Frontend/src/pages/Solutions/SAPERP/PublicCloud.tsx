...
const PublicCloud = () => {
 ...
 <SolutionPageLayout
      ...
      breadcrumbs={[{ name: "Solutions" }, { name: "SAP ERP" }, { name: "Public Cloud", path: "/solutions/public-cloud" }]}
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Solutions/public-hero.jpg?tr=f-auto,q-auto,w-1600"
