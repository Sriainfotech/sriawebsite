...
const PrivateCloud = () => {
 ...
 <SolutionPageLayout
      ...
      breadcrumbs={[{ name: "Solutions" }, { name: "SAP ERP" }, { name: "Private Cloud", path: "/solutions/private-cloud" }]}
      backgroundImage="https://ik.imagekit.io/hps6th7vy/sria/Solutions/private-hero.jpg?tr=f-auto,q-auto,w-1600"
